image bgbus = "Slide 35.png"
label scene6:
    scene bgbus
    show orang_l at pos_right
    show robot at pos_left

    robot_n "Now for the last, but definitely not least."
    ...
    robot_n "You even remember that it's G.E as the last operation."
    ...
    scene bgbus
    show robot at pos_right
    robot_n "Good, that’s what I want to hear!"
    ...
    robot_n "G.E stands for Global Engagement."
    ...
    scene bgbus
    show robot at pos_right
    robot_n "I need you to either create or join a community and participate in all the communal tasks."

    robot_n "With that in mind, Let's do this!"
